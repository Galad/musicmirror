...
#if X64
		const string DLLName = "LibFlac_dynamic_x64";
#else
		const string DLLName = "LibFlac_dynamic";
#endif
...
#region Decoder API
		...
		public delegate StreamDecoderWriteStatus Decoder_WriteCallback(IntPtr context, IntPtr frame, IntPtr buffer, IntPtr userData);
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate StreamDecoderReadStatus Decoder_StreamDecoderReadCallback(IntPtr context, IntPtr bufferHandle, ref int byteCount, IntPtr clientData);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate StreamDecoderSeekStatus Decoder_StreamDecoderSeekCallback(IntPtr context, ulong absolute_byte_offset, IntPtr client_data);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate StreamDecoderTellStatus Decoder_StreamDecoderTellCallback(IntPtr context, ref ulong absolute_byte_offset, IntPtr client_data);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate StreamDecoderLengthStatus Decoder_StreamDecoderLengthCallback(IntPtr context, ref ulong stream_length, IntPtr client_data);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]	
		public delegate int Decoder_StreamDecoderEofCallback(IntPtr context, IntPtr client_data);	
